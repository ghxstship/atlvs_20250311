...
CREATE FUNCTION register_demo_user(user_id uuid)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
CREATE FUNCTION check_demo_status(user_id uuid)
RETURNS TABLE (
  is_demo boolean,
  is_active boolean,
...
CREATE FUNCTION reset_demo_data(user_id uuid)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
CREATE FUNCTION cleanup_demo_data(user_id uuid)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
